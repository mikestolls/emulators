...
namespace gameboy
{
	...
	namespace input
	{
		...
		void set_button_pressed(u8 button, bool is_directional)
		{
			u8* input = 0;
			if (is_directional)
			{
		...
		void set_button_released(u8 button, bool is_directional)
		{
			if (is_directional)
			{
		...
		u8 get_button_state(u8 button, bool is_directional)
		{
			if (is_directional)
			{
